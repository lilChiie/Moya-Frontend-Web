          ...
          <template #body-cell-actions="props">
            <q-td :props="props">
              <div class="row items-center justify-center q-gutter-x-xs">
                ...
                >
                  <q-tooltip>Edit Tourism Type</q-tooltip>
                </q-btn>
                ...
                >
                  <q-tooltip>Delete Tourism Type</q-tooltip>
                </q-btn>
              </div>
            </q-td>
          </template>
        ...
        <q-card-section class="q-pa-lg">
          <q-form @submit.prevent="saveForm">
            <div class="q-mb-md">
              ...
              <q-input
                v-model="form.name"
                placeholder="e.g. Beach & Marine Tourism, Cultural..."
                outlined
                dense
                bg-color="white"
                class="rounded-field"
...
const nameRules = [
  (val) => !!val?.trim() || 'Tourism Type Name is required',
  (val) => {
    if (!val) return true
    ...
    return !duplicate || 'Tourism type with this name already exists'
  },
]
...
async function saveForm() {
  ...
  if (isDuplicate) {
    feedbackConfig.value = {
      ...
      message: `Tourism type "${inputName}" already exists! Duplicate entries are not allowed.`,
    }
    showStatusFeedback.value = true
    return
  }
